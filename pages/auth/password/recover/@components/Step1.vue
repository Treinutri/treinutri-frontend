  ...
  <div>
    ...
    <v-radio-group v-model="selectedRecoverModeValue" class="mt-8">
      ...
      >
        ...
        <app-text as="span" color="gray-400" class="flex-fill">dav************@gmail.com</app-text>

        <app-button class="flex-grow-1 flex-sm-grow-0" size="sm" background="secondary">
          <app-text size="sm" as="span" color="primary">Email</app-text>
        </app-button>
      </app-box>
      ...
      >
        ...
        <app-button class="flex-grow-1 flex-sm-grow-0" size="sm" background="secondary">
          <app-text size="sm" as="span" color="primary">Celular</app-text>
        </app-button>
      </app-box>
    </v-radio-group>
  </div>
