    ...
    <student-container>
      <div class="header__content">
        ...
        <div class="d-flex align-center gap-20">
          <client-only>
            <student-menu-profile @logout="isModalLogoutOpen = true" />
            ...
            <app-button v-if="smAndDown" rounded :translucid="true" width="52" height="52">
              <ph-list
...
import StudentMenuProfile from './StudentMenuProfile.vue'
