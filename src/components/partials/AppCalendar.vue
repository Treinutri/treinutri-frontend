...
const calendarDateMemo = reactive<{ month: string | number; data: IDateInfoObject[] | [] }>({
  month: '',
  data: [],
})
...
function getCalendarDays() {
  ...
  calendarDateMemo.month = Number(getMonth(currentDate.value))
  calendarDateMemo.data = [
...
watchEffect(() => {
  if (getMonth(currentDate.value) !== calendarDateMemo.month) {
    getCalendarDays()
  }
})
</script>
